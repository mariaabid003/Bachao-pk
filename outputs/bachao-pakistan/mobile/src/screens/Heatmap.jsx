...
// Static Karachi area data — mirrors backend/data/karachi_crime.csv
const KARACHI_AREAS = [
          ...
          <View key={i} style={[s.areaCard, { borderLeftColor: RISK_COLOR[area.risk] }]}>
            <View style={s.areaLeft}>
              <View style={s.areaNameRow}>
                ...
                <View style={[s.riskChip, { backgroundColor: RISK_BG[area.risk], borderColor: RISK_BORDER[area.risk] }]}>
...
const s = StyleSheet.create({
  ...
  areaNameRow:  { flexDirection: 'row', alignItems: 'center', gap: 8, marginBottom: 4 },
  areaName:     { color: C.text, fontSize: 14, fontWeight: '700' },
  ...
  areaBar:      { height: 4, backgroundColor: C.surface2, borderRadius: 2, overflow: 'hidden' },
  areaBarFill:  { height: 4, borderRadius: 2 },
  areaRight:    { alignItems: 'center' },
